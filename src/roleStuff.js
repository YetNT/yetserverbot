...
roles.main = {
    ...
    field: {
        ...
        content: [
            "Obtain *some* these roles in : <#929047224988631080>",
...
roles.main.description = roles.main.description.join("\n");
roles.main.field.content = roles.main.field.content.join("\n");

roles.level = {
    title: "Levelled Roles",
    description: [
...
roles.level.description = roles.level.description.join("\n");
...
roles.booster.description = roles.booster.description.join("\n");

const main = new EmbedBuilder()
    .setTitle(roles.main.title)
    .setDescription(roles.main.description)
    .setFields([
        {
            name: roles.main.field.name,
            value: roles.main.field.content,
        },
    ]);

const level = new EmbedBuilder()
    .setTitle(roles.level.title)
    .setDescription(roles.level.description);

const booster = new EmbedBuilder()
    .setTitle(roles.booster.title)
    .setDescription(roles.booster.description);

module.exports = [main, level, booster];
